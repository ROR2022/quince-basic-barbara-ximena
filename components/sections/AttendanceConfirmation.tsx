      ...
      <div className="max-w-2xl mx-auto relative bg-slate-300 bg-opacity-30 rounded-3xl" style={{ zIndex: 2 }}>
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p
              className={`text-xl text-black bg-slate-300 bg-opacity-60 rounded-2xl p-6 leading-relaxed max-w-lg mx-auto transition-all duration-1000 delay-1000 ${
                isVisible 
                  ? 'opacity-100 translate-y-0' 
                  : 'opacity-0 -translate-y-8'
              }`}
          ...
          <form onSubmit={handleConfirmAttendance} className="space-y-6">
            ...
            <div className={`pt-4 text-center transition-all duration-1000 delay-7000 ${
              ...
              <p className={`mt-4 text-sm opacity-75 text-black bg-emerald-200 bg-opacity-50 p-4 rounded-xl transition-all duration-1000 delay-8000 ${
                isVisible 
