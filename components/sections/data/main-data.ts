export const quinceMainData = {
  hero: {
    ...
    backgroundVideo: "/video/portada.mp4",
    quote:
  ...
  event: {
    ...
    ceremony: {
      time: "17:00 hrs.",
      venue: "Catedral del Sagrado Corazón de Jesús",
      address: "Calle Sonora no 166 norte, Col. Centro, Cajeme, Sonora",
      type: "Misa de Acción de Gracias",
      ubiLink: "https://maps.app.goo.gl/rKq6Edwkdks8Sd688",
  ...
  attendance: {
    whatsappNumber: "5216442112035", //+52 1 644 211 2035
